...
function HeroComponent() {
  return (
    <section className="flex flex-col lg:flex-row justify-between gap-6 items-center w-full h-[calc(100vh-78px)]">
      ...
      <div className="w-full max-w-[800px] mx-auto lg:w-[50%] relative -mt-10 lg:-mt-16 animate-left h-full">
        <div className=" w-64 md:w-80 xl:w-96  absolute  translate-x-10 sm:translate-x-30 translate-y-5 lg:translate-x-10 lg:translate-y-40   p-1 rounded-lg overflow-hidden bg-white cursor-pointer hover:z-10 hover:scale-105 transition-all duration-250 ease-in-out">
          <img src={COMMUNITY_IMAGE_ONE} alt="community" className="w-full" />
        </div>
        <div className="w-64 md:w-80 xl:w-96 absolute  translate-x-30 sm:translate-x-80 translate-y-30 lg:translate-x-50 lg:translate-y-70    p-1 rounded-lg overflow-hidden bg-white cursor-pointer hover:z-10 hover:scale-105 transition-all duration-250 ease-in-out">
          <img src={COMMUNITY_IMAGE_TWO} alt="community" />
        </div>
        <div className="w-64 md:w-80 xl:w-96 absolute  translate-x-10 sm:translate-x-40 translate-y-55 lg:translate-x-20 lg:translate-y-100    p-1 rounded-lg overflow-hidden bg-white cursor-pointer hover:z-10 hover:scale-105 transition-all duration-250 ease-in-out">
